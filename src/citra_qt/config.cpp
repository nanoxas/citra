...
void Config::ReadValues() {
    ...
    Settings::values.layout_option = static_cast<Settings::Layout::LayoutOption>(qt_config->value("layout_option").toInt());
...
void Config::SaveValues() {
    ...
    qt_config->setValue("layout_option", Settings::values.layout_option);
